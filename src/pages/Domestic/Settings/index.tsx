    ...
    <AppLayout activeSection="settings">
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            onClick={handleSave}
            className="inline-flex items-center gap-2 bg-frigus-primary hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-xs self-start sm:self-auto cursor-pointer"
          >
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-gray-200/80 shadow-xs space-y-6">
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-2xl bg-gray-50/70 border border-gray-100 flex items-center justify-between gap-4">
              ...
              <button className="px-3.5 py-1.5 rounded-xl border border-gray-200 bg-white text-xs font-bold text-frigus-navy hover:bg-gray-50 transition-colors shadow-2xs cursor-pointer">
                Editar
              </button>
            </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-red-100 shadow-xs space-y-4">
          ...
          <button className="px-4 py-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 text-xs font-bold transition-colors border border-red-200 cursor-pointer">
            Excluir minha conta
          </button>
        </div>
      </div>
